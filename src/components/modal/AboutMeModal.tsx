...
const AboutMeModal = ({showModal, setShowModal}: ModalProps) => {
  return (
    <>
      <CustomAntdModal width={900} centered open={showModal} onCancel={() => setShowModal(false)} footer={null}>
        <div className={'modalFlexBox'}>
          <ModalTitle title={'프론트엔드 개발자 이승진입니다.'} />
          <Row className={'aboutBox'}>
            <Col className={'left'} span={12}>
              <div>
                ...
                키웠습니다.
                <br />
                <br /> 배운 것을 기록하고 공유하기 위해 블로그에 글을 작성하며, 지식을 체계적으로 관 리하여 필요할 때
                쉽게 참고할 수 있도록 노력하고 있습니다.
                <br />
                <br /> 비전공자로서 아직은 모르는 것이 많지만, 그것을 부끄러워하지 않고 오히려 모르는 것을 인정하며
                끊임없이 질문 하는 자세를 유지하고 있습니다. <br />
                <br />
                이러한 접근을 통해 실력을 빠르게 향상시키며 성장하고 있으며. 앞으로도 끊임없는 도전과 성장을 통해 더
